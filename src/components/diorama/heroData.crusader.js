  ...
  krak: {
    ...
    components: [
      ...
      },
      {
        ...
        points: [
          { x: 0, z: 10, r: 2.3, h: 11.5, plinthH: 1.2, plinthDrop: 0.62, plinthTopScale: 1.2, plinthBottomScale: 1.34, label: 'Torre Grande (Grosser Turm)', info: 'Der maechtigste Turm des Krak und letzter Rueckzugspunkt der Johanniter.' },
          { x: -9.51, z: 3.09, r: 2.0, h: 10.0, plinthH: 1.02, plinthDrop: 0.56, plinthTopScale: 1.2, plinthBottomScale: 1.34, label: 'Suedwestturm (Waechterturm)', info: 'Einer der drei massiven Suedtuerme mit senkrechten Abwurfwinkeln auf Angreifer am Mauerfuss.' },
          ...
          { x: 9.51, z: 3.09, r: 1.9, h: 9.5, plinthH: 0.98, plinthDrop: 0.54, plinthTopScale: 1.2, plinthBottomScale: 1.34, label: 'Suedostturm (Torre del Maestre)', info: 'Flankiert den Rampeneingang zum Innenhof und schliesst die starke Suedfront.' },
        ],
