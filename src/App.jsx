...
function renderPlanSafe(castle,props){
  const plan=resolveCastlePlan(castle);
  if(!plan) return <GenericCastlePlan castle={castle} {...props}/>;
  try{
    return plan(props);
  }catch(err){
    console.error("Plan render failed, fallback active:", castle?.id, err);
    return <GenericCastlePlan castle={castle} {...props}/>;
  }
}
                            ...
                            <div style={{
                              ...
                              <svg
                                ...
                                {viewMode==="iso"
                                  ...
                                  : renderPlanSafe(sel,{ac:sel.theme.accent,sel:selZone,onZone:setSelZone})
                                }
...
function BattleMap({castle,interactive}){
  ...
  const planNode=renderPlanSafe(castle,{ac,sel:selZone,onZone:setSelZone});
    ...
    <div style={{padding:"16px 18px",animation:"fadeIn 0.25s ease"}}>
      ...
      <div style={{background:"rgba(8,6,3,0.95)",border:`1px solid ${ac}18`,borderRadius:"8px",
        ...
        <svg viewBox="0 0 220 200" style={{width:"100%",display:"block",maxHeight:"320px"}}>
          ...
          {renderPlanSafe(castle,{ac,sel:selZone,onZone:setSelZone})}
        </svg>
      </div>
