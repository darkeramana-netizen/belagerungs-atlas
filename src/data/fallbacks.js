...
export const LEXIKON_OFFLINE = {
  ...
  castle_sorrow:["Burgfeste Drachenstein wurde unter Großmeister Harwin in mehreren Bauphasen ausgebaut — 1389 hielt Großmeisterin Sera von Dunmoor die Festung 11 Monate gegen ein kirchliches Heer.","Zwischen 1150 und 1580 entstand die gestaffelte Dreifach-Kernburg mit Unterem, Mittlerem und Oberem Burghof sowie starkem Bergfried.","Der Ordensrat trägt das Geheimnis kollektiv. Stirbt ein Mitglied, überträgt es sein Wissen in einem Ritual das niemand außerhalb bezeugt hat.","Sollte Burgfeste Drachenstein fallen, verschwinden Karten und Ritter nach Gravecrest. Drei Ritter kennen den Weg — nur sie.","Die größte Schwäche ist die Fläche: Hafenviertel und Stadttor brauchen viele Verteidiger, sonst entstehen schnell tote Winkel."],
