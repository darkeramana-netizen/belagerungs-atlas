// Offline fallback responses and data — extracted from App.jsx

export const ROLEPLAY_RESPONSES = {
  early: [
...
export const SIMULATOR_FALLBACKS = [
...
export const LEXIKON_OFFLINE = {
  ...
  castle_sorrow:["Burgfeste Drachenstein wurde zwischen 1050 und dem 18. Jahrhundert in sechs Bauphasen ausgebaut — vom Urkern zur vollwertigen Hafenfeste.","Die Anlage wuchs stufenweise: Untere Burg (Marktviertel), Mittlere und Obere Burg mit Palas/Kapelle/Bergfried sowie späterer Drachenkai mit Hafeninfrastruktur.","1389 hielt Großmeisterin Sera von Dunmoor Drachenstein elf Monate gegen ein kirchliches Heer — trotz Unterzahl und Seeblockade.","Der Ordensrat trägt das Geheimnis kollektiv. Stirbt ein Mitglied, überträgt es sein Wissen in einem Ritual das niemand außerhalb bezeugt hat.","Die größte Schwäche ist die Fläche: Hafenviertel und Stadttor brauchen viele Verteidiger, sonst entstehen schnell tote Winkel."],
  ashenveil:["Burg Ashenveil wurde als vierte Bastion des Ordens in den Mooren gegründet, um Wasserwege und geheime Nachschubrouten zu kontrollieren.","Die Festung kombiniert Sumpfgraben, Zugbrücken und überdachte Gänge — ideal für nasses Klima und lange Belagerungen.","Im Marstall von Ashenveil standen Moorpferde mit breiten Hufen bereit, spezialisiert auf sumpfiges Gelände.","Die größte Gefahr in Ashenveil ist nicht der Feind, sondern die Feuchte: Schimmel, Seuchen und morsches Holz fordern Disziplin.","Fällt Ashenveil, verliert der Orden seine flexible Logistikachse zwischen Drachenstein und Gravecrest."],
  gravecrest:["Erbaut von Großmeister Talvyn dem Stillen: 'Eine Burg die man nicht sehen kann, kann man nicht nehmen.' Gravecrest steht auf keiner offiziellen Karte.","1312 flohen Ritter nach der Niederlage von Burgfeste Drachenstein nach Gravecrest — von dort organisierten sie den Gegenangriff der die Festung in 40 Tagen zurückholte.","Das Signalfeuer von Gravecrest sieht beide anderen Burgen gleichzeitig — Rauchsignale am Tag, Feuerzeichen nachts, Hornsignale bei Alarm.","Von Gravecrest aus sieht man Burgfeste Drachenstein und den Schwarzen Bergfried zugleich — wer Gravecrest kontrolliert, kontrolliert die Information des Ordens.","Nie eingenommen. Nicht durch Stärke — durch Unsichtbarkeit. Ein Dutzend Mann kann auf dem einzigen Pfad Hunderte aufhalten."],
  // Batch 3
...
export function getLexikonFacts(castle) {
